...
Conscient de l’évolution du spectacle vivant et des enjeux de son époque, il fonde la Compagnie Datura pour contribuer au renouvellement du public et de l’image de l’opéra.`,
  ...
  },
  {
    ...
    text: `Mathilde Bellin est née en 1993, a grandi dans le Tarn, et vit désormais à Villeurbanne. Elle est metteuse en scène, autrice et dramaturge. Diplômée de l'École Normale Supérieure de Lyon en Arts de la scène et Dramaturgie en 2016, elle se forme également au jeu au Conservatoire d'Arts Dramatique de Toulouse et au Laboratoire de Formation au Théâtre Physique à Montreuil. 
Elle travaille durant un an en qualité de dramaturge et conseillère littéraire pour le Théâtre National Populaire de Villeurbanne, auprès de Christian Schiaretti.  En thèse de doctorat de 2018 à 2021, elle enseigne l'Histoire de la mise en scène à l'Université Paris VIII. Depuis septembre 2023, elle est enseignante en licence d'Arts du spectacle à l'Université Lumière Lyon 2.
Co-directrice artistique de la compagnie de théâtre La Syncope, avec qui elle écrit et met en scène Tout ce qu'il y a dans le ventre des poissons (Prix du Jury du Festival de théâtre de Maisons-Laffitte en 2022) ainsi qu'un second spectacle à destination des jeunes publics, intitulé Quand le loup n'y est plus, Mathilde Bellin donne également des cours de théâtre amateurs et des ateliers d’écritures dans différentes structures publiques (médiathèques, associations).
En 2025, elle est à la mise en scène de l'opéra Lakmé pour la compagnie Datura.`,
    role: "Metteuse en Scène",
  },
  {
    name: "Guillemette Daboval",
    text: `Cheffe d’orchestre spécialisée dans l’opéra et le travail avec la voix, Guillemette Daboval a un attachement particulier à la musique française. Sa présence à l’Opéra-Comique au sein de l’Académie Favart l’amène à travailler en étroite collaboration avec Louis Langrée sur L’Heure espagnole (Ravel) et Pulcinella (Stravinsky), ainsi qu’avec Laurent Campellone sur Fantasio (Offenbach).
Elle collabore aussi avec Barbara Hannigan, Debora Waldman, Hervé Niquet, Laurence Equilbey, et diverses maisons d’opéra : Opéra Royal de Versailles, Théâtre des Champs-Élysées, Opéra de Dijon, Opéra de Rouen, Opéra de Tours, Opéra de Toulon. Depuis 2021, elle travaille régulièrement avec l’Orchestre des Champs-Élysées et le TAP de Poitiers.
Diplômée du CNSMD de Lyon, elle étudie également le chant et la direction d’orchestre auprès de Julien Masmondet, Enrique Mazzola et Debora Waldman.
En 2022, elle dirige Carmen (Bizet) avec le North Czech Philharmonic Orchestra et est cheffe assistante au Berlin Opernfest pour Die Fledermaus (Strauss). Elle est aussi cheffe invitée du Chœur de Radio France pour la création du Dream Requiem de Rufus Wainwright. Fondatrice de l’ensemble Esquisses, elle enregistre Par un matin en 2023. Elle dirige également Lakmé pour la Cie Datura (mise en scène : Mathilde Bellin).`,
    role: "Directrice Musicale",
  },
  {
...
Pour le projet Lakmé, elle travaille main dans la main avec Frank Gizycki et Rachel Testard pour imaginer des costumes en parfaite harmonie avec le décor et les chorégraphies. Pensés comme de véritables accessoires, ils occupent une place essentielle dans la mise en scène.`,
  ...
  {
    name: "Frank Gizycki",
    text: `Frank Gizycki est un artiste chorégraphique basé à Bruxelles. Il se forme au sein du Conservatoire National Supérieur de Musique et de Danse de Lyon, de l’Ecole des Sables (Sénégal) et à P.A.R.T.S (Bruxelles) dont il est diplômé en 2016. Depuis, il est interprète pour Anne Teresa De Keersmaeker, Jason Respilieux, Baptiste Conte et Le Balcon, avec lesquel·le·s, il parcourt les scènes européennes et mondiales au travers de projets de répertoire et de créations, et des projets in situ (musées, parcs, rues…).

Il est membre de l’ensemble Figure, du Collectif Meal et de la compagnie Datura avec lesquels il crée et explore la relation de la danse à la musique contemporaine, jazz et d’opéra.
Depuis 2022, il co-organise le festival Débord'DesRives qui relaie et soutient des initiatives artistiques, citoyennes et paysannes dans le Tarn (France).
